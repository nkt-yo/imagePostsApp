            ...
            <div class="contents">
                ...
                <div class="main">
                  <div class="flex border w-full mt-6 px-6 py-4 shadow-md sm:rounded-lg">
                    <form action="/postImage" method="POST" class="w-full max-w-lg" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                          ...
                          <div class="select-image mb-4">
                          <input class="" id="image" name="image" type="file" accept="image/png, image/jpeg">
                          </div>
